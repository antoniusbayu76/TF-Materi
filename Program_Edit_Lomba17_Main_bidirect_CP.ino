...
void remote()
{
  ...
  //Maju Ke Depan
  if (ch3 > 1600 & ch3 <= 1800){ //kiri vertical ke atas
    ThrusterSpeed1.write(buttonPushCounter-70);
    ThrusterSpeed2.write(buttonPushCounter-70);
  }

  if (ch3 > 1800){ //kiri vertical ke atas
...
/*Dikasih Gap antara berhenti dengan bergerak untuk antisipasi sinyal bocor*/
  ...
  if (ch3 < 1200){ //kiri vertical ke bawah
    ThrusterSpeed1.write(1300);
    ThrusterSpeed2.write(1300);
  }
}
